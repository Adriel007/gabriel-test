...
<body>
    ...
    // select apenas do pet cujo o código foi dado na página "quero-adotar.php" através da url usando GET
    $pet = select("Pet", "*", "code_ = ".$_GET['codigo'])[0];
            ...
            <div class="row align-items-start">
                <div class="col-8 d-flex">
                    ...
                    <div class="col-9 rounded overflow-hidden">
                        <img src="img/<?php echo $pet['image_'] ?>"
                        alt="Tini" class="object-fit-cover w-100 ms-3" height="530">
                    </div>
                </div>
                ...
                <div class="py-3 col-4 d-flex flex-wrap row-gap-3">                   
                    ...
                    <div class="col-6">
                        ...
                        <div>
                            <?php echo $pet['weight_'] ?>kg
                        </div>
                    </div>

                    <div class="col-6">
                        <h3 class="fs-sm destaque m-0">Idade</h3> 
                        <div><?php echo $pet['age_'].($pet['age_'] > 1 ? " anos" : " ano")  ?></div>
                    </div>
